...
<body style="background-color: #E0F0F8;">
	...
	<form class="form-horizontal" action="xuqiu_zhuce.action?username=${adminBean.name}"
		...
		<center>
			...
			<button class="button" type="submit"  name="submit" style="font-size:20px" formaction="xuqiu_baocun.action?username=${adminBean.name}">保存</button>
